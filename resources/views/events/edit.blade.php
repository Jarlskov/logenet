    ...
    <div class="panel-body">
        <form method="POST" action="/events/{{ $event->id }}" class="form-horizontal event-form" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input id="image" name="image" type="file" class="file-loading" @if($event->image)data-initial-preview="<img src='{{ asset('storage/' . $event->image) }}'>"@endif data-show-upload="false">
                </div>
            </div>
            <div class="form-group">
